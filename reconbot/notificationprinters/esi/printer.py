...
class Printer(object):
    ...
    def get_notification_text(self, notification):
        ...
        types = {
            ...
            'AcceptedAlly' : self.unknown,
            'AcceptedSurrender' : self.unknown,
            'AgentRetiredTrigravian' : self.unknown,
            'AllMaintenanceBillMsg' : self.unknown,
            'AllStrucInvulnerableMsg' : self.unknown,
            'AllStructVulnerableMsg' : self.unknown,
            'AllWarCorpJoinedAllianceMsg' : self.unknown,
            'AllWarRetractedMsg' : self.unknown,
            'AllWarSurrenderMsg' : self.unknown,
            'AllianceWarDeclaredV2' : self.unknown,
            'AllyContractCancelled' : self.unknown,
            'AllyJoinedWarAllyMsg' : self.unknown,
            'AllyJoinedWarDefenderMsg' : self.unknown,
            'BattlePunishFriendlyFire' : self.unknown,
            'BillOutOfMoneyMsg' : self.unknown,
            'BountyESSShared' : self.unknown,
            'BountyESSTaken' : self.unknown,
            'BountyPlacedAlliance' : self.unknown,
            'BountyPlacedChar' : self.unknown,
            'BountyPlacedCorp' : self.unknown,
            'BountyYourBountyClaimed' : self.unknown,
            'BuddyConnectContactAdd' : self.unknown,
            'CharAppRejectMsg' : self.unknown,
            'CharMedalMsg' : self.unknown,
            'CharTerminationMsg' : self.unknown,
            'CloneActivationMsg' : self.unknown,
            'CloneActivationMsg2' : self.unknown,
            'CloneMovedMsg' : self.unknown,
            'CloneRevokedMsg1' : self.unknown,
            'CloneRevokedMsg2' : self.unknown,
            'CombatOperationFinished' : self.unknown,
            'ContactAdd' : self.unknown,
            'ContactEdit' : self.unknown,
            'ContainerPasswordMsg' : self.unknown,
            'ContractRegionChangedToPochven' : self.unknown,
            'CorpAppAcceptMsg' : self.unknown,
            'CorpAppInvitedMsg' : self.unknown,
            'CorpAppRejectCustomMsg' : self.unknown,
            'CorpAppRejectMsg' : self.unknown,
            'CorpBecameWarEligible' : self.unknown,
            'CorpFriendlyFireDisableTimerCompleted' : self.unknown,
            'CorpFriendlyFireDisableTimerStarted' : self.unknown,
            'CorpFriendlyFireEnableTimerCompleted' : self.unknown,
            'CorpFriendlyFireEnableTimerStarted' : self.unknown,
            'CorpKicked' : self.unknown,
            'CorpLiquidationMsg' : self.unknown,
            'CorpNewsMsg' : self.unknown,
            'CorpNoLongerWarEligible' : self.unknown,
            'CorpOfficeExpirationMsg' : self.unknown,
            'CorpStructLostMsg' : self.unknown,
            'CorpWarDeclaredV2' : self.unknown,
            'CorpWarFightingLegalMsg' : self.unknown,
            'CorpWarInvalidatedMsg' : self.unknown,
            'CorpWarRetractedMsg' : self.unknown,
            'CorpWarSurrenderMsg' : self.unknown,
            'CustomsMsg' : self.unknown,
            'DistrictAttacked' : self.unknown,
            'DustAppAcceptedMsg' : self.unknown,
            'ESSMainBankLink' : self.unknown,
            'ExpertSystemExpired' : self.unknown,
            'ExpertSystemExpiryImminent' : self.unknown,
            'FWAllianceKickMsg' : self.unknown,
            'FWAllianceWarningMsg' : self.unknown,
            'FWCharKickMsg' : self.unknown,
            'FWCharRankGainMsg' : self.unknown,
            'FWCharRankLossMsg' : self.unknown,
            'FWCharWarningMsg' : self.unknown,
            'FWCorpJoinMsg' : self.unknown,
            'FWCorpKickMsg' : self.unknown,
            'FWCorpLeaveMsg' : self.unknown,
            'FWCorpWarningMsg' : self.unknown,
            'FacWarCorpJoinRequestMsg' : self.unknown,
            'FacWarCorpJoinWithdrawMsg' : self.unknown,
            'FacWarCorpLeaveRequestMsg' : self.unknown,
            'FacWarCorpLeaveWithdrawMsg' : self.unknown,
            'FacWarLPDisqualifiedEvent' : self.unknown,
            'FacWarLPDisqualifiedKill' : self.unknown,
            'FacWarLPPayoutEvent' : self.unknown,
            'FacWarLPPayoutKill' : self.unknown,
            'GameTimeAdded' : self.unknown,
            'GameTimeReceived' : self.unknown,
            'GameTimeSent' : self.unknown,
            'GiftReceived' : self.unknown,
            'IHubDestroyedByBillFailure' : self.unknown,
            'IncursionCompletedMsg' : self.unknown,
            'IndustryOperationFinished' : self.unknown,
            'IndustryTeamAuctionLost' : self.unknown,
            'IndustryTeamAuctionWon' : self.unknown,
            'InsuranceExpirationMsg' : self.unknown,
            'InsuranceFirstShipMsg' : self.unknown,
            'InsuranceInvalidatedMsg' : self.unknown,
            'InsuranceIssuedMsg' : self.unknown,
            'InsurancePayoutMsg' : self.unknown,
            'InvasionCompletedMsg' : self.unknown,
            'InvasionSystemLogin' : self.unknown,
            'InvasionSystemStart' : self.unknown,
            'JumpCloneDeletedMsg1' : self.unknown,
            'JumpCloneDeletedMsg2' : self.unknown,
            'KillRightAvailable' : self.unknown,
            'KillRightAvailableOpen' : self.unknown,
            'KillRightEarned' : self.unknown,
            'KillRightUnavailable' : self.unknown,
            'KillRightUnavailableOpen' : self.unknown,
            'KillRightUsed' : self.unknown,
            'LocateCharMsg' : self.unknown,
            'MadeWarMutual' : self.unknown,
            'MercOfferRetractedMsg' : self.unknown,
            'MercOfferedNegotiationMsg' : self.unknown,
            'MissionCanceledTriglavian' : self.unknown,
            'MissionOfferExpirationMsg' : self.unknown,
            'MissionTimeoutMsg' : self.unknown,
            'MutualWarExpired' : self.unknown,
            'MutualWarInviteAccepted' : self.unknown,
            'MutualWarInviteRejected' : self.unknown,
            'MutualWarInviteSent' : self.unknown,
            'NPCStandingsGained' : self.unknown,
            'NPCStandingsLost' : self.unknown,
            'OfferToAllyRetracted' : self.unknown,
            'OfferedSurrender' : self.unknown,
            'OfferedToAlly' : self.unknown,
            'OfficeLeaseCanceledInsufficientStandings' : self.unknown,
            'OldLscMessages' : self.unknown,
            'OperationFinished' : self.unknown,
            'RaffleCreated' : self.unknown,
            'RaffleExpired' : self.unknown,
            'RaffleFinished' : self.unknown,
            'ReimbursementMsg' : self.unknown,
            'ResearchMissionAvailableMsg' : self.unknown,
            'RetractsWar' : self.unknown,
            'SeasonalChallengeCompleted' : self.unknown,
            'SovCorpBillLateMsg' : self.unknown,
            'SovCorpClaimFailMsg' : self.unknown,
            'SovDisruptorMsg' : self.unknown,
            'SovStructureSelfDestructCancel' : self.unknown,
            'SovereigntyIHDamageMsg' : self.unknown,
            'SovereigntySBUDamageMsg' : self.unknown,
            'SovereigntyTCUDamageMsg' : self.unknown,
            'StationAggressionMsg1' : self.unknown,
            'StationAggressionMsg2' : self.unknown,
            'StationStateChangeMsg' : self.unknown,
            'StoryLineMissionAvailableMsg' : self.unknown,
            'StructureCourierContractChanged' : self.unknown,
            'StructureImpendingAbandonmentAssetsAtRisk' : self.unknown,
            'StructureItemsDelivered' : self.unknown,
            'StructureItemsMovedToSafety' : self.unknown,
            'StructuresJobsCancelled' : self.unknown,
            'StructuresJobsPaused' : self.unknown,
    ...
    def unknown(self):
        return 'This message is not implemented yet'
